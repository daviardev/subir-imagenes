...
//import { v4 } from "uuid"; agrega un ID único al nombre de la imagen.
...
const DragImage = ({ setMedia, setLoading }) => {
    ...
    const handleSave = () => {
		...
		if (valid && file) {
            ...
            setLoading(true);
            const imageRef = ref(dbStorage, `/${file.name}`); // file.name + v4() Añade un id único a la imagen que se suba
